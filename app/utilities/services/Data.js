function Data($http, $q, $rootScope, domo) {
	...
	// 		"Monitored by Whom": "Leslie Sheldon",
	// 		"Monitoring Methodology": "Monthly Metric: Non-Contracted, Non-Clean Claims > 60 days / All",
	// 		"Monitoring Period": "3/27/2016 - 4/2/2016",
	// 		"Universe Size": 862,
	// 		"Sample Size": 862,
		...
		if (!the_data.all_data) {
			return domo.get('/data/v1/capmetrics')
				.then(function(result) {
					console.log('capmetrics result', result);
				...
				.then(function(result) {
					...
					console.log('all_data wk 1 CAP 1A', the_data.all_data.filter(function(item){return item.Week === 1 && item['CAP #'] === '1A';}));
